...
//  Project13
//
//  Created by Phillip Reynolds on 1/5/23.
//
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func setFilter(action: UIAlertAction) {
        ...
        updateChangeFilterButtonTitle(to: actionTitle)

        applyProcessing()
    }
    
    func updateChangeFilterButtonTitle(to newTitle: String) {
        let newTitleLabel = "Filter: \(newTitle)"
        
        changeFilterButton.setTitle(newTitleLabel, for: .normal)
    }
    ...
    func showImageNotLoadedError() {
        let ac = UIAlertController(title: "Error", message: "No image has been loaded.", preferredStyle: .alert)
    ...
    func enableSlider(ofType: SliderType) {
        switch ofType {
        case .intensity:
